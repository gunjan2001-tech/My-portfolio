    ...
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4 ">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right">
                Hi, i'm Gunjan vaishnav
            </h1>
            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            "I'm a Frontend Developer skilled in JavaScript, HTML, CSS, and Bootstrap, with beginner-level experience in React and Tailwind CSS. I focus on building responsive and user-friendly websites. Currently, I'm working on real-world projects to enhance my skills and aiming to master full-stack development." 🚀
            </p>
